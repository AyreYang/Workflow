...
namespace TestConsole.Models
{
    ...
    {
        public Model3(IDatabaseAccessor accessor) : base(accessor, Guid.Parse("71553376-df34-41c5-a71e-e88009b2c974"))
        {
        }
        ...
        public override void CreateWorkFlow()
        {
            ...
            ent_wf.NameCN = "工作流模型3";
            ent_wf.NameEN = "WorkFlowModel3";
            ent_wf.Version = 1;
